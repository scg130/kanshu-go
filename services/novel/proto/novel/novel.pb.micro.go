...
type NovelSrvService interface {
	...
	GetNoteNum(ctx context.Context, in *NoteNumReq, opts ...client.CallOption) (*NoteNumRsp, error)
	GetNovelsByUserId(ctx context.Context, in *RequestByUserId, opts ...client.CallOption) (*NovelsResponse, error)
}
...
func (c *novelSrvService) GetNoteNum(ctx context.Context, in *NoteNumReq, opts ...client.CallOption) (*NoteNumRsp, error) {
	req := c.c.NewRequest(c.name, "NovelSrv.GetNoteNum", in)
	out := new(NoteNumRsp)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (c *novelSrvService) GetNovelsByUserId(ctx context.Context, in *RequestByUserId, opts ...client.CallOption) (*NovelsResponse, error) {
	req := c.c.NewRequest(c.name, "NovelSrv.GetNovelsByUserId", in)
	out := new(NovelsResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type NovelSrvHandler interface {
	...
	GetNoteNum(context.Context, *NoteNumReq, *NoteNumRsp) error
	GetNovelsByUserId(context.Context, *RequestByUserId, *NovelsResponse) error
}
...
func RegisterNovelSrvHandler(s server.Server, hdlr NovelSrvHandler, opts ...server.HandlerOption) error {
	type novelSrv interface {
		...
		GetNoteNum(ctx context.Context, in *NoteNumReq, out *NoteNumRsp) error
		GetNovelsByUserId(ctx context.Context, in *RequestByUserId, out *NovelsResponse) error
	}
...
func (h *novelSrvHandler) GetNoteNum(ctx context.Context, in *NoteNumReq, out *NoteNumRsp) error {
	return h.NovelSrvHandler.GetNoteNum(ctx, in, out)
}

func (h *novelSrvHandler) GetNovelsByUserId(ctx context.Context, in *RequestByUserId, out *NovelsResponse) error {
	return h.NovelSrvHandler.GetNovelsByUserId(ctx, in, out)
}
